...
ORGANIZATION_SUSPENDED = _add("organization-suspended", 403, "Organization unavailable")
...
GROUNDING_STALE = _add("grounding-stale", 409, "Product facts changed")
...
LIFECYCLE_SEQUENCE_STALE = _add("lifecycle-sequence-stale", 409, "Lifecycle sequence changed")
SERVICE_TERM_INVALID = _add("service-term-invalid", 422, "Service term invalid")
OFFBOARDING_EPISODE_STALE = _add("offboarding-episode-stale", 409, "Offboarding episode changed")
PURGE_ALREADY_CLAIMED = _add("purge-already-claimed", 409, "Purge already claimed")
OPERATION_ID_REUSE = _add("operation-id-reuse", 409, "Operation id reused")
RETENTION_POLICY_UNVERIFIED = _add("retention-policy-unverified", 503, "Retention policy unverified")
LIFECYCLE_HISTORY_UNVERIFIED = _add("lifecycle-history-unverified", 503, "Lifecycle history unverified")
OFFBOARDING_QUIESCENCE_PENDING = _add("offboarding-quiescence-pending", 503, "Offboarding quiescence pending")
SOURCE_UNAVAILABLE = _add("source-unavailable", 409, "Source unavailable")
